...
object Permissions {
  ...
  fun check(context: Context, permissions: Array<String>, rationale: String?,
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      ...
      permissions.toCollection(permissionsList)

      val allPermissionProvided = permissionsList.none {
  ...
  class Options : Serializable {
    ...
    var settingsDialogMessage = "Required permission(s) have been set" + " not to ask again! Please provide them from settings."
